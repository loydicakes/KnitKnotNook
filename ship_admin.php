...
<body>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="viewModalLabel">SHIPPING INFORMATION</h5>
                </div>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">DELETE SHIPPING INFORMATION</h5>
                ...
                <div class="modal-footer">
                    <form action="s_actions.php" method="POST">
    ...
    <main class="container pt-3">
        ...
        <div class="card" style="margin-top: 130px;">
            <div class="card-header" style="background-color: #fff6f6;">
                <h1 class="text">ITEMS TO BE SHIPPED</h1>
            </div>
            <div class="card-body">
                <table class="table table-bordered" border="3">
                    <thead>
                        <tr class="table-success" style="text-align: center;">
                            <th style="background-color: #ffa6c1;">ShipID</th>
                            <th style="background-color: #ffc4d6;">Customer</th>
                            <th style="background-color: #ffa6c1;">Item</th>
                            <th style="background-color: #ffc4d6;">Address</th>
                            <th style="background-color: #ffa6c1;">Payment Option</th>
                            <th style="background-color: #ffc4d6;">Ship Cost</th>
                            <th style="background-color: #ffa6c1;">Total Cost</th>

    ...
    <main class="container pt-3">
        ...
        <div class="card" style="margin-top: 130px;">
            <div class="card-header" style="background-color: #fff6f6;">
                <h1 class="text">ITEMS ADDED IN CART</h1>
            </div>
            <div class="card-body">
                <table class="table table-bordered" border="3">
                    <thead>
                        <tr style="text-align: center;">
                            ...
                            <th style="background-color: #ffa6c1;">Image</th>
                            <th style="background-color: #ffc4d6;">Price</th>
                            <th style="background-color: #ffa6c1;">Username</th>
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr class="table" style="text-align: center;">
                                    ...
                                    <td><img style="height: 60px; width:80px" src="<?php echo $rows[2]; ?>" alt="" width="50"></td>

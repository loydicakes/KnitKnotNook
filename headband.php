...
<body>
    ...
    <section class="catHeadband" id="catHeadband">
        <div class="catHeader">
            <div class="headFlower" id="headFlower" >
                <a href="flower.php">Flower</a>
            </div>
            <div class="headHeadband" id="headHeadband" style="background: #FADDE1; color: black;">
